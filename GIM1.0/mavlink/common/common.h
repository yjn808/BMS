...
#define MAVLINK_COMMON_XML_HASH -4251656783269025727
...
typedef enum MAV_SYS_STATUS_SENSOR
{
   ...
   MAV_SYS_STATUS_EXTENSION_USED=(int)2147483648, /* 0x80000000 Extended bit-field are used for further sensor status bits (needs to be set in onboard_control_sensors_present only) | */
   MAV_SYS_STATUS_SENSOR_ENUM_END=(int)2147483649, /*  | */
...
typedef enum HIL_SENSOR_UPDATED_FLAGS
{
   ...
   HIL_SENSOR_UPDATED_RESET=(int)2147483648, /* Full reset of attitude/position/velocities/etc was performed in sim (Bit 31). | */
   HIL_SENSOR_UPDATED_FLAGS_ENUM_END=(int)2147483649, /*  | */
