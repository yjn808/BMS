...
//   RAMGS13     : origin = 0x019000, length = 0x001000     /* Only Available on F28379D, F28377D, F28375D devices. Remove line on other devices. */
   RAMGS6_13       : origin = 0x012000, length = 0x008000
...
SECTIONS
{
   ...
   record_data      : > RAMGS6_13 , PAGE = 1
            ...
            .TI.ramfunc : {} LOAD = FLASHH,
                             ...
                             PAGE = 0, ALIGN(8)
                             {
                             --library=rts2800_fpu32_fast_supplement_coff.lib (.text)
                             }
        #endif
    #else
...
//    FPUmathTables : > FLASHD , PAGE = 0

	  FPUmathTables : LOAD = FLASHD,
	             	  RUN = RAMLS4,
