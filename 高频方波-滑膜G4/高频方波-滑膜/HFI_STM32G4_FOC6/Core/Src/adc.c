...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA3     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = VTEMP_Pin|AMPU1_Pin|AMPV1_Pin|AMPW1_Pin;
  ...
  */
    ...
    PB2     ------> ADC2_IN12
    */
    GPIO_InitStruct.Pin = BEMFW_Pin|GPIO_PIN_5;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOC, VTEMP_Pin|AMPU1_Pin|AMPV1_Pin|AMPW1_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB2     ------> ADC2_IN12
    */
    HAL_GPIO_DeInit(GPIOC, BEMFW_Pin|GPIO_PIN_5);
